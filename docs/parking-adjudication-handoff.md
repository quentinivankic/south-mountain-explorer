...
| `public/areas/parking-verdicts.json` | **EXISTS since 2026-09-13** — generated by `scripts/build-parking-verdicts.py`; consumed by the sweep, the pool builder and `add-parking.py` (section 14 records the decision) |
