...
const BAD_RE =
  /\b(cemetery|graveyard|golf|country club|playground|playfield|ball ?field|ball ?park|baseball|softball|soccer|tennis|skate ?park|dog ?park|pool|aquatic|community center|water tower|substation|parking|rest area|mini[- ]park|pocket park|tot lot|memorial garden)\b/i;
...
function looksReal(name) {
  ...
  // Reject pure numbers / addresses like "1", "2", "114"
  if (/^\d+$/.test(n)) return false;
  // Reject single-word numeric-prefixed entries like "26th" alone
